...
class Linx extends React.Component<ProgressProps, any> {
  constructor(props) {
    super(props);
    this.state = {
      percent: 0,
  ...
  render() {
    ...
    return (
      <div>
        <h3>Milestone Tracker: {percent}%</h3>
        ...
        <p> 
          <button className='button-28' type="button" onClick={this.changeState}>
            Color Swap
          </button>
          <button class="button-28" type="button" onClick={this.changeIncrease}>
            Milestone
          </button>
